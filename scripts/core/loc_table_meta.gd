...
const T := {
	...
	"rules_s9_body": {
		"tr": "Köyleri geç, sonda [color=#b3272d]Alfa sürüsü[/color] boss köyünü yen (gecede [b]2 av[/b]!). Kazanınca [color=#ffd479]para[/color] → [b]dükkânda kalıcı muska[/b] al (Zırh, Pusula, Hafıza Taşı...). Köy içinde sıkışırsan sağ alttaki [color=#ffd479]para puluyla[/color] o günlüğüne +1 sorgu hakkı satın alabilirsin — fiyat her alışta artar. [b]Çile[/b] = her seferden sonra açılan zorluk katmanı (daha az sorgu, daha çok kurt, omen zorunlu...).",
		"en": "Pass through the villages, then beat the [color=#b3272d]alpha pack[/color] boss village at the end ([b]2 kills[/b] a night!). Winning earns [color=#ffd479]coin[/color] → buy [b]lasting charms at the shop[/b] (Armor, Compass, Memory Stone...). If you are stuck mid-village, the [color=#ffd479]coin chip[/color] at the bottom right buys +1 question for the day — the price climbs with each purchase. [b]Ordeal[/b] = the difficulty layer that opens after each journey (fewer questions, more wolves, omen guaranteed...).",
	},
	...
	"rules_s11_title": {"tr": "Dedektif Araçları — Yüzleştirme, Hipotez, Defter", "en": "Detective Tools — Confrontation, Hypothesis, Ledger"},
	"rules_s11_body": {
		"tr": "• [b]YÜZLEŞTİRME (Y):[/b] Y'ye bas, önce konuşacak kartı seç, sonra hedefi tıkla. Seçtiğin karakter [b]doğrudan hedef hakkında[/b] konuşur — 2 sorgu hakkına nokta atışı bilgi. Konuşan kurtsa bu ifadesi de yalandır; yalan da kanıttır.\n• [b]HİPOTEZ (H):[/b] İmleç bir kartın üstündeyken H'ye bas — oyun \"bu kişi kurt olsaydı ne olurdu?\" diye hesaplar. [color=#b3272d]Kızıl halka[/color] = o varsayımda kesin kurt, [color=#8fe0a0]yeşil halka[/color] = kesin koyun. Varsayım hiçbir çözümde tutmuyorsa o kişi [b]kesin koyundur[/b] — bedava kanıt. Kapatmak için tekrar H.\n• [b]İFADE DEFTERİ (TAB):[/b] Verilen tüm ifadeler, gece ölümleri ve avların dökümü tek sayfada. Kaybolduğunda önce defteri aç.",
		"en": "• [b]CONFRONTATION (Y):[/b] Press Y, pick the speaker, then click a target. Your chosen character speaks [b]directly about the target[/b] — pinpoint information for 2 questions. If the speaker is a wolf, this statement is a lie too; and lies are also proof.\n• [b]HYPOTHESIS (H):[/b] Hover a card and press H — the game computes \"what if this one is a wolf?\" [color=#b3272d]Red ring[/color] = certain wolf under that assumption, [color=#8fe0a0]green ring[/color] = certain sheep. If no solution holds, that character is [b]certainly a sheep[/b] — free proof. Press H again to close.\n• [b]TESTIMONY LEDGER (TAB):[/b] Every statement, night death and cull in one page. When you feel lost, open the ledger first.",
	},
	"rules_s12_title": {"tr": "Gece Trafiği — İz Bırakan Roller", "en": "Night Traffic — Roles That Leave Trails"},
	"rules_s12_body": {
		"tr": "Bazı roller geceleri köyde dolaşır ve şafakta [b]iz[/b] bırakır; bu izler de ceset gibi asla yalan söylemez:\n• [color=#e4a72e]Otacı:[/color] günün SON sorguladığın kişiye gece şifaya gider — kurt oraya saldırırsa kimse ölmez ([i]sessiz şafak[/i]).\n• [color=#e4a72e]Gözcü:[/color] her şafak, komşularına gece kaç ziyaret geldiğini bedava söyler.\n• [color=#e4a72e]Seyyah:[/color] her gece saat yönündeki en yakın canlıya misafir olur.\n• [color=#e4a72e]Tazı:[/color] her şafak katilin hangi yönden geldiğini koklar.\n• [color=#e4a72e]Tuzakçı:[/color] bir koltuğa gecelik kapan kurar — av oraya düşerse kurt canlı yakalanır.",
		"en": "Some roles walk the village at night and leave [b]trails[/b] at dawn; like corpses, these trails never lie:\n• [color=#e4a72e]Herbalist:[/color] visits the LAST character you questioned that day — if the wolf strikes there, no one dies (a [i]quiet dawn[/i]).\n• [color=#e4a72e]Watcher:[/color] each dawn, reports how many night visits their neighbors received — free.\n• [color=#e4a72e]Wayfarer:[/color] each night, guests at the nearest living neighbor clockwise.\n• [color=#e4a72e]Hound:[/color] each dawn, sniffs out the direction the killer came from.\n• [color=#e4a72e]Trapper:[/color] sets a trap on a seat for the night — if the hunt falls there, the wolf is caught alive.",
	},
	"rules_s13_title": {"tr": "Köy Kuralları — Baştan İlan Edilir", "en": "Village Rules — Declared Up Front"},
	"rules_s13_body": {
		"tr": "Bazı köyler özel bir kuralla gelir; kural [b]baştan ilan edilir[/b] (sol paneldeki ⚠ şeridi):\n• [b]Suskun Sürü:[/b] herkes yalnız 1 ifade verir.\n• [b]Kanlı Ay:[/b] gecede 2 av — ama günde +1 sorgu hakkı.\n• [b]Kuraklık:[/b] yanlış av −7 can.\n• [b]Sinsi Kurt:[/b] en küçük numaralı canlı kurt her gece EN ÇOK sorgulanana sürtünür — iz bırakır, öldürmez.\n• [b]Dönek Alfa:[/b] TEK günler en yakını, ÇİFT günler en uzağı avlar. Cesetleri güne göre oku.",
		"en": "Some villages come with a special rule, [b]declared up front[/b] (the ⚠ strip on the left panel):\n• [b]Silent Flock:[/b] everyone gives only 1 statement.\n• [b]Blood Moon:[/b] 2 kills a night — but +1 question a day.\n• [b]Drought:[/b] a wrong cull costs 7 health.\n• [b]Prowler:[/b] the lowest-numbered living wolf brushes past the MOST-questioned each night — leaves traces, no kill.\n• [b]Fickle Alpha:[/b] hunts the nearest on ODD days, the farthest on EVEN days. Read the corpses by the day.",
	},
